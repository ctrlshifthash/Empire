...
export const CHARACTERS: CharacterType[] = [
  ...
  { id: "gake", name: "Gake", icon: "🟩", color: "#4caf50", hat: null, cape: false, rarity: "common", priceCoins: 15000, priceRumble: 4000, maxSupply: 2000, image: "/characters/gake/card.png", desc: "A familiar face from the timeline." },
  { id: "pingu", name: "Pingu Charts", icon: "🐧", color: "#5dade2", hat: null, cape: false, rarity: "common", priceCoins: 20000, priceRumble: 5000, maxSupply: 1500, image: "/characters/pingu/card.png", desc: "Charts up, vibes up." },
  { id: "sling", name: "Sling", icon: "🪢", color: "#e67e22", hat: null, cape: false, rarity: "common", priceCoins: 25000, priceRumble: 6000, maxSupply: 1200, image: "/characters/sling/card.png", desc: "Quick hands, quicker exits." },
  { id: "fibonacki", name: "Fibonacki", icon: "🌀", color: "#9b59b6", hat: null, cape: false, rarity: "rare", priceCoins: 60000, priceRumble: 14000, maxSupply: 300, image: "/characters/fibonacki/card.png", desc: "Everything retraces to him." },
  { id: "json1444", name: "json1444", icon: "🧩", color: "#34495e", hat: null, cape: false, rarity: "rare", priceCoins: 70000, priceRumble: 16000, maxSupply: 250, image: "/characters/json1444/card.png", desc: "Reads the chain like an open book." },
  { id: "remus", name: "Remus", icon: "🐺", color: "#7f8c8d", hat: null, cape: false, rarity: "rare", priceCoins: 85000, priceRumble: 19000, maxSupply: 200, image: "/characters/remus/card.png", desc: "Runs with the pack, leads it too." },
  { id: "mert", name: "mert", icon: "⚡", color: "#f39c12", hat: null, cape: false, rarity: "epic", priceCoins: 180000, priceRumble: 40000, maxSupply: 60, image: "/characters/mert/card.png", desc: "Wired into the network." },
  { id: "rains", name: "Rains Revenge", icon: "🌧️", color: "#2c3e50", hat: null, cape: false, rarity: "epic", priceCoins: 220000, priceRumble: 50000, maxSupply: 45, image: "/characters/rains/card.png", desc: "When it pours, he collects." },
