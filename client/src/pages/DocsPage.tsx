    ...
    body: (
      <>
        ...
        <p>
          ...
          <strong>1 SOL</strong> pool accrues to your wallet, claimable as Solana. Don’t hold the token? You can still
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>
          The total paid out is still <strong>hard-capped at 1 SOL per day</strong> across everyone — the tier and play
